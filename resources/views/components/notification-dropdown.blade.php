            ...
            @foreach($notifications as $notification)
                ...
                <div class="flex gap-4 px-6 py-5 hover:bg-gray-50 transition group relative">
                    ...
                    <form method="POST"
                          ...
                          class="absolute right-4 top-4 opacity-0 group-hover:opacity-100 transition">

                        @csrf
                        @method('DELETE')

                        <button type="submit"
                                class="p-1 rounded-md text-red-500 hover:bg-red-100 transition">
                    ...
                    <div class="w-12 h-12 rounded-full 
                        ...
                        <i data-lucide="{{ $notification->data['icon'] ?? 'bell' }}"
                           class="w-5 h-5 {{ $notification->data['icon_color'] ?? 'text-gray-600' }}"></i>
